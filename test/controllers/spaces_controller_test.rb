...
class SpacesControllerTest < ActionController::TestCase
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post :create, space: { area: @space.area, multiplier: @space.multiplier, name: @space.name, spaceType: @space.spaceType }
    end
  ...
  test "should update space" do
    patch :update, id: @space, space: { area: @space.area, multiplier: @space.multiplier, name: @space.name, spaceType: @space.spaceType }
    assert_redirected_to space_path(assigns(:space))
  end
