...
class BasicsControllerTest < ActionController::TestCase
  ...
  test "should create basic" do
    assert_difference('Basic.count') do
      post :create, basic: { endTime: @basic.endTime, startTime: @basic.startTime, timeStep: @basic.timeStep, type: @basic.type }
    end
  ...
  test "should update basic" do
    patch :update, id: @basic, basic: { endTime: @basic.endTime, startTime: @basic.startTime, timeStep: @basic.timeStep, type: @basic.type }
    assert_redirected_to basic_path(assigns(:basic))
  end
